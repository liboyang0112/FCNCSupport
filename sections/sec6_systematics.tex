...
\item Jet flavour tagging systematics. The uncertainties on the $b$-tagging are assessed independently for $b$, $c$ and light-flavour quark jets, with extrapolation factors \cite{btag_sys1}. The efficiencies and mis-tag rates are measured in data using the methods described in \cite{btag_sys2}-\cite{btag_sys3} with the 2015, 2016, 2017, and 2018 data set. There are 85 NPs assigned for the flavour tagging systematics with 20 NPs for light flavor, 20 for $c$, 45 for $b$, and 1 for extrapolation.

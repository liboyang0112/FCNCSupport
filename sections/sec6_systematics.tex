...
Table \ref{tab:tab_norm_NP} gives the QCD fake estimation for $\thadhad$ channel in \ref{sec:ss_method} and six fake normalization factor NPs for fake method mentioned in \ref{sec:sf_method}.
The lists of systematic NPs that survive the pruning are in Tab. \ref{tab:tab_specific_NP} and \ref{tab:tab_common_NP}, and their meanings are given below. All the NPs in Tab. \ref{tab:tab_common_NP} and the fakeSF* in \ref{tab:tab_norm_NP} are fully correlated in all signal regions.

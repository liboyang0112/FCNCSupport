...
\begin{itemize}
	\item FSR up: ``isr:muRfac=10_fsr:muRfac=05''
	\item FSR down: ``isr:muRfac=10_fsr:muRfac=05''
	\item ISR up: ``Var3cUp''
...
An additional $1.6\%$ uncertainty on BR($H\to\tau\tau$) is also assigned \cite{HiggsBR} besides the theoretical uncertainties: PDF, $\alpha_s$, ISR, FSR and scale.

The fake calibration is also applied to the fake tau part of the signal the same way as the background.

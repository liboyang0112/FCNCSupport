...
The Higgs mass resolution is set to 20~GeV respectively according to the \cite{Htautau}. The $\met$ resolution is parametrized as
\begin{equation}
...
\item $\Delta R(\tau,b-jet)$ is the angular distance between the tau and b-jet. If there are two taus in the event, the leading one is selected for the calculation.

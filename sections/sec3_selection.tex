...
The S/B is significantly improved after applying these cuts and the yield of the CR generated is shown in Table \ref{tab:hadhadCR_yield}

While in the leptonic channels, except $l\thadhad$, a $\met>20$GeV cut is used to reduce QCD background and also provide QCD enriched control regions.

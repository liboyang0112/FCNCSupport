...
In the leptonic channels, exactly one lepton with $\pt>10$ GeV passing \texttt{Tight} ID as defined in Sec. \ref{sec:obj_reco} is required. %Trigger cuts can be regarded as independent and additional to these offline cuts.) is required.
...
%\begin{figure}[htb]
%\centering
%\includegraphics[width=0.4\textwidth]{figures/lephad/lh_njet30_os.eps}
%\put(-50, 80){\textbf{(a)}}
%\put(-50, 95){\footnotesize{$lh$}}
%\includegraphics[width=0.4\textwidth]{figures/hadhad/hh_njet30_os.eps}
%\put(-50, 80){\textbf{(b)}}
%\put(-50, 95){\footnotesize{$hh$}}
%\caption{ The distributions of the number of jets in the $\tlhad$ (left) and $\thadhad$ (right) channels. }
%\label{fig:njet30}
%\end{figure}

\begin{figure}[htb]
\centering
\includegraphics[page=6,width=0.4\textwidth]{figures/r21/thq1lntau/MCBasedBkgModellingWithttHMLNumbers/reg1l1tau1b3j_os_vetobtagwp70/x1fit.pdf}
\put(-140, 92){\footnotesize{TTH $\tlhad$}}
\includegraphics[page=6,width=0.4\textwidth]{figures/r21/thq1lntau/MCBasedBkgModellingWithttHMLNumbers/reg1l1tau1b3j_os_vetobtagwp70/x2fit.pdf}
\put(-140, 92){\footnotesize{TTH $\tlhad$}}\\
\includegraphics[page=4,width=0.4\textwidth]{figures/r21/thq2tau/SSOSWithFakeMCCalibrated/reg2mtau1b3jos/x1fit.pdf}
\put(-140, 92){\footnotesize{TTH $\thadhad$}}
\includegraphics[page=4,width=0.4\textwidth]{figures/r21/thq2tau/SSOSWithFakeMCCalibrated/reg2mtau1b3jos/x2fit.pdf}
\put(-140, 92){\footnotesize{TTH $\thadhad$}}
...
%\begin{figure}[htb]
%\centering
%\includegraphics[width=0.4\textwidth]{figures/lephad/nbjet_4j.eps}
%\put(-50, 80){\textbf{(a)}}
%\put(-57, 95){\footnotesize{$lh$ 4-jet}}
%\includegraphics[width=0.4\textwidth]{figures/hadhad/nbjet_4j.eps}
%\put(-50, 80){\textbf{(b)}}
%\put(-57, 95){\footnotesize{$hh$ 4-jet}}
%\caption{ The distributions of the number of $b$-tagged jets in the $\tlhad$ 4-jet (a) and $\thadhad$ 4-jet (b) categories, before the $N_{\text{bjet}}$=1 cut is applied. The definition of 4-jet categories is given in Sec. \ref{sec:reconstruction}. }
%\label{fig:nbjet_4j}
%\end{figure}
...
\input{tables/cutflow/cutflow_all}
\input{tables/cutflow/cutflow_reg1l1tau1b2j_os}
\input{tables/cutflow/cutflow_reg1l1tau1b2j_ss}
\input{tables/cutflow/cutflow_reg1l1tau1b3j_os}
\input{tables/cutflow/cutflow_reg1l1tau1b3j_ss}
\input{tables/cutflow/cutflow_reg1l2tau1bnj_os}
\input{tables/cutflow/cutflow_reg1l2tau1bnj_ss}
...
\input{tables/prefit/yield_chart_tthML}
\input{tables/prefit/significance_chart_tthML}

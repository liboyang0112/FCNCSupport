...
To give a better impression on the numbers, we use $\text{BR}(t\to qH)=0.2\%$ as benchmark, which is corresponding to ($C^{13}_{u\phi})^2 + (C^{31}_{u\phi})^2=3.89$, $\sigma(ug\to tH)=1421.8$ pb, $\sigma(cg\to tH)=206.0$ pb. The same TopFCNC UFO model has also been adapted by other FCNC tqH searches in different Higgs decay $H\rightarrow\gamma\gamma$ and $H\rightarrow b\bar b$

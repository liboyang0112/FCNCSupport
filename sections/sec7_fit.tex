...
\includegraphics[width=0.45\textwidth]{\FCNCFigures/tthML/Limit/tcH_NuisPar.pdf}
...
\includegraphics[width=0.45\textwidth]{\FCNCFigures/tthML/Limit/tcH_CorrMatrix.pdf}
%\put(-50, 150){\textbf{(a)}}

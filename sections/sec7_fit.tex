...
\begin{figure}[htb]
\centering
\includegraphics[width=0.49\textwidth]{\FCNCFigures/xTFW/Limit/tuH_Pruning_0.pdf}
\includegraphics[width=0.49\textwidth]{\FCNCFigures/xTFW/Limit/tuH_Pruning_1.pdf}
\caption{ The NP pruning in hadronic channels. }
\label{fig:xTFW_pruning}
\end{figure}

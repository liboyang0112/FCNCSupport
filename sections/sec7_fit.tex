...
The luminosity is also slightly over-constrained by the high statistics data in the signal regions in the leptonic channels and is correlated with
PLIV, ``$\bar{t}t$ FSR'', and ``$\bar{t}t$ Scale'' between 10-20\%. 
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{\FCNCFigures/closureCheck/RankingSysts_SigXsecOverSM_tuH.pdf}
\includegraphics[width=0.45\textwidth]{\FCNCFigures/closureCheck/RankingSysts_SigXsecOverSM_tcH.pdf}
...
\begin{figure}[htb]
\centering
\includegraphics[width=1\textwidth]{\FCNCFigures/closureCheck/tuH_CorrMatrix.pdf}
...
\begin{figure}[htb]
\centering
\includegraphics[width=1\textwidth]{\FCNCFigures/closureCheck/tcH_CorrMatrix.pdf}

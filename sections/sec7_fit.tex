...
%Figure \ref{fig:sig_strength} shows the negative logrithm profile likelihood as a function of the signal strength (BR($t\to Hq$)=$1\%$ is assumed), with the $1\sigma$ confidence interval indicated. The best fit signal strength is $1.00_{-0.21}^{+0.25}$.

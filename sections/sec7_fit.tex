...
%\put(-50, 150){\textbf{(a)}}
\caption{ The asimov fit ranking of the top 30 NPs for $\thadhad$ channels (left) and leptonic channels in terms of tuH merged signal. The scale of the relative impact on $\mu$ (the pull) of the NPs is shown on the top (bottom) axis.}

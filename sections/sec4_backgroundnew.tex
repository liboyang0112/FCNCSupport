...
\caption{The FFs derived by the $\Htautau$ group.The first table represent lnm FF for 1p,The second table represent nm FF for 1p}
\input{\FCNCTables/xTFW/FF/FF_nominal_1p}
\end{table}

\begin{table}
\caption{The FFs derived by the $\Htautau$ group.The first table represent lnm FF for 3p,The second table represent nm FF for 3p}
...
\begin{table}
\label{tab:FF_ss_1p}
\caption{The FFs derived by us in same-sign regions,The first table represent lnm FF for 1p,The second table represent nm FF for 1p}
...
\begin{table}
\label{tab:FF_ss_3p}
\caption{The FFs derived by us in same-sign regions,The first table represent lnm FF for 3p,The second table represent nm FF for 3p}
%\input{\FCNCTables/xTFW/FF_htautau}
...
\begin{table}
\label{tab:FF_sb_1p}
\caption{The FFs derived by us in sideband regions,The first table represent lnm FF for 1p,The second table represent nm FF for 1p}
%\input{\FCNCTables/xTFW/FF_htautau}
...
\begin{table}
\label{tab:FF_sb_3p}
\caption{The FFs derived by us in sideband regions,The first table represent lnm FF for 3p,The second table represent nm FF for 3p}
%\input{\FCNCTables/xTFW/FF_htautau}
...
\item The FF is rederived in the SS CR using $1m1ntau1b2jss+1m1ntau1b3jss$, $1n1mtau1b2jss+1n1mtau1b2jss$, and $2mtau1b2jss+2mtau1b3jss$ to account for the limitations of the parametrization of the fake-factors.The fake factor are presented in Table \ref{tab:FF_ss_1p},Table \ref{tab:FF_ss_3p}

...
\begin{table}[htb]
\caption{ The expected statistical only $95\%$ CL exclusion upper limits on BR$(t\to Hc)$ and BR$(t\to Hu)$ (0.2\%) with the Asimov (B-only) in the leptonic channels.}
...
\begin{table}[htb]
\caption{ The expected $95\%$ CL exclusion upper limits with fake-estimation-method systematics only on BR$(t\to Hc)$ and BR$(t\to Hu)$ (0.2\%) with the Asimov (B-only) in the hadronic channels.}

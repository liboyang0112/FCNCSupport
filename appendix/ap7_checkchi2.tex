...
Figure \ref{fig:ap7_ttmass} - \ref{fig:ap7_ttmass_removedchi2} - \ref{fig:ap7_ttmass_mmc} shows the distributions of $m_{\tau,\tau}$ using different method in the hadronic channels. Good agreement between data and background predictions are achieved.
...
%\put(-40, 140){\textbf{(c)}}
%\includegraphics[width=0.49\textwidth]{\FCNCFigures/xTFW/checkMassWindowYield/NOMINAL_removedchi_20210724/reg2mtau1b2jos_vetobtagwp70_highmet/tau_pt_0.pdf}
\includegraphics[width=0.49\textwidth]{\FCNCFigures/xTFW/showFake/NOMINAL/reg2mtau1b3jss_vetobtagwp70_highmet/tautaumass.pdf}
\put(-40, 140){\textbf{(b)}}

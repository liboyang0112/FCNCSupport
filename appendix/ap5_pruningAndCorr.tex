...
\caption{ The asimov fit correlation matrix ($\%$) of different NPs, with a threshold of $1\%$ for hadronic channels (left) combined and lepton channels combined (right) in terms of tcH merged signal . }
...
\caption{ The asimov fit correlation matrix ($\%$) of different NPs, with a threshold of $1\%$ for hadronic channels (left) combined and lepton channels combined (right) in terms of $\bar{t}t\to bWcH$ signal . }
...
\caption{ The asimov fit correlation matrix ($\%$) of different NPs, with a threshold of $1\%$ for hadronic channels (left) combined and lepton channels combined (right) in terms of $\bar{t}t\to bWuH$ signal . }
...
\caption{ The asimov fit correlation matrix ($\%$) of different NPs, with a threshold of $1\%$ for hadronic channels (left) combined and lepton channels combined (right) in terms of $cg\to tH$ signal . }
...
\caption{ The asimov fit correlation matrix ($\%$) of different NPs, with a threshold of $1\%$ for hadronic channels (left) combined and lepton channels combined (right) in terms of $ug\to tH$ signal . }

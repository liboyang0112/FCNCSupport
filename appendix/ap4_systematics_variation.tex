...
\caption{The background change caused by FSR variation in leptonic channels.}
\label{fig:tthML_FSR}
\end{figure}
...
\caption{The background change caused by ABCD\_electron variation in leptonic channels.}

...
\begin{itemize}
	\item $\bar{t}t$ PS in Table \ref{fig:tthML_ttbarPS}.
	\item $\bar{t}t$ ME in Table \ref{fig:tthML_ttbarME}.
	\item Scale in Table \ref{fig:tthML_scale}.
	\item TES\_DETECTOR in Table \ref{fig:tthML_TES_DETECTOR}.
	\item FSR in Table \ref{fig:tthML_FSR}.
	\item ABCD electron in Table \ref{fig:tthML_ABCD_electron}.
\end{itemize}

In hadronic channels:
\begin{itemize}
	\item $\bar{t}t$ PS in Table \ref{fig:xTFW_ttbarPS}.
	\item $\bar{t}t$ ME in Table \ref{fig:xTFW_ttbarME}.
\end{itemize}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{\FCNCFigures/xTFW/trexfitter/ttbarPS/reg2mtau1b2jos_Combined_ttbarPS.pdf}
\includegraphics[width=0.45\textwidth]{\FCNCFigures/xTFW/trexfitter/ttbarPS/reg2mtau1b3jos_Combined_ttbarPS.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{\FCNCFigures/xTFW/trexfitter/ttbarME/reg2mtau1b2jos_Combined_ttbarME.pdf}
\includegraphics[width=0.45\textwidth]{\FCNCFigures/xTFW/trexfitter/ttbarME/reg2mtau1b3jos_Combined_ttbarME.pdf}
